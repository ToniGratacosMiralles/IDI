...
void main() {
  //per a Lambert necessitem Normal en SCO i L en SCO


  // PosVertex en SCO per a cada vertex
    vec4 vertexSCO = view * TG * vec4(vertex, 1.0);

  // PosFocus en SCO NO EL PASSEM A SCO, EL DEIXEM EN SCA
    //vec4 posFocusSCO = view * vec4(posFocus, 1.0);

  // L en SCO
    //Direcció de la llum per a cada vertex

...
QT_MOC_LITERAL(1, 11, 12), // "changedFocus"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1), // "n"
QT_MOC_LITERAL(4, 27, 9), // "moveFocus"
QT_MOC_LITERAL(5, 37, 8), // "pinkWall"
QT_MOC_LITERAL(6, 46, 9) // "greenWall"

    },
    "MyGLWidget\0changedFocus\0\0n\0moveFocus\0"
    "pinkWall\0greenWall"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->changedFocus((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->moveFocus((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->pinkWall(); break;
        case 3: _t->greenWall(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::changedFocus)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::changedFocus(int _t1)
{
